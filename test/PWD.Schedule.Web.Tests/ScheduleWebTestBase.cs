...
{
    public abstract class ScheduleWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ScheduleWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ScheduleWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ScheduleDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ScheduleDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ScheduleDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ScheduleDbContext, Task<T>> func)
        {
            T result;
