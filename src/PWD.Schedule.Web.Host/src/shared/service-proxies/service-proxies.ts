...
export class InstrumentServiceProxy {
     ...
     */
    abc(): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Instrument/abc";
        url_ = url_.replace(/[?&]$/, "");
...
export class EstimateItemDto implements IEstimateItemDto {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.totalValue = _data["totalValue"];
            this.workType = _data["workType"];
            this.isAnalysis = _data["isAnalysis"];
    ...
    toJSON(data?: any) {
        ...
        data["totalValue"] = this.totalValue;
        data["workType"] = this.workType;
        data["isAnalysis"] = this.isAnalysis;
...
export class EstimateProjectDto implements IEstimateProjectDto {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.numberofBuildings = _data["numberofBuildings"];
    ...
    toJSON(data?: any) {
        ...
        data["numberofBuildings"] = this.numberofBuildings;
